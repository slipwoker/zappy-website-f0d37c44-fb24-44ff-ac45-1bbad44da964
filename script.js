        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'f0d37c44-fb24-44ff-ac45-1bbad44da964',
                name: data.name || data.fullName || data.fullname || '',
                email: data.email || '',
                subject: data.subject || 'Contact Form Submission',
                message: data.message || data.comments || data.details || '',
                phone: data.phone || data.telephone || data.mobile || null
              })
            });
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "V-LAND משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
